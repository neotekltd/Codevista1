      ...
      <section className="bg-[var(--primary)] py-12 md:py-16 text-white">
        ...
        >
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
            ...
            <button
              type="submit"
              className="md:col-span-2 bg-white text-[var(--primary)] px-8 py-3 rounded-md font-semibold text-base sm:text-lg shadow-md transition-colors duration-300 w-full md:w-auto md:justify-self-center hover:bg-gray-100 hover:scale-105 active:scale-95"
            >
              VALIDER
            </button>
          </form>
